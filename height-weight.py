...
fig.add_trace(go.Scatter(x=[height_mean, height_mean], y=[0, 0.27], mode="lines", name="MEAN"))
fig.add_trace(go.Scatter(x=[height_first_std_deviation_start, height_first_std_deviation_start], y=[0, 0.27], mode="lines", name="STANDARD DEVIATION 1"))
fig.add_trace(go.Scatter(x=[height_first_std_deviation_end, height_first_std_deviation_end], y=[0, 0.27], mode="lines", name="STANDARD DEVIATION 1"))
fig.add_trace(go.Scatter(x=[height_second_std_deviation_start, height_second_std_deviation_start], y=[0, 0.27], mode="lines", name="STANDARD DEVIATION 2"))
fig.add_trace(go.Scatter(x=[height_second_std_deviation_end, height_second_std_deviation_end], y=[0, 0.27], mode="lines", name="STANDARD DEVIATION 2"))
fig.add_trace(go.Scatter(x=[height_third_std_deviation_start, height_third_std_deviation_start], y=[0, 0.27], mode="lines", name="STANDARD DEVIATION 3"))
fig.add_trace(go.Scatter(x=[height_third_std_deviation_end, height_third_std_deviation_end], y=[0, 0.27], mode="lines", name="STANDARD DEVIATION 3"))
fig.show()

fig = ff.create_distplot([weight_list], ["Result"], show_hist=False)
fig.add_trace(go.Scatter(x=[weight_mean, weight_mean], y=[0, 0.04], mode="lines", name="MEAN"))
fig.add_trace(go.Scatter(x=[weight_first_std_deviation_start, weight_first_std_deviation_start], y=[0, 0.04], mode="lines", name="STANDARD DEVIATION 1"))
fig.add_trace(go.Scatter(x=[weight_first_std_deviation_end, weight_first_std_deviation_end], y=[0, 0.04], mode="lines", name="STANDARD DEVIATION 1"))
fig.add_trace(go.Scatter(x=[weight_second_std_deviation_start, weight_second_std_deviation_start], y=[0, 0.04], mode="lines", name="STANDARD DEVIATION 2"))
fig.add_trace(go.Scatter(x=[weight_second_std_deviation_end, weight_second_std_deviation_end], y=[0, 0.04], mode="lines", name="STANDARD DEVIATION 2"))
fig.add_trace(go.Scatter(x=[weight_third_std_deviation_start, weight_third_std_deviation_start], y=[0, 0.04], mode="lines", name="STANDARD DEVIATION 3"))
fig.add_trace(go.Scatter(x=[weight_third_std_deviation_end, weight_third_std_deviation_end], y=[0, 0.04], mode="lines", name="STANDARD DEVIATION 3"))
fig.show()
